...
#import "NBMSettingsModel+Private.h"
#import "NBMSettingsStore.h"
...
@interface NBMSettingsModel () {
  NBMSettingsStore *_settingsStore;
}
@end

@implementation NBMSettingsModel
...
- (NBMSettingsStore *)settingsStore {
  if (!_settingsStore) {
    _settingsStore = [[NBMSettingsStore alloc] init];
    [self registerStoreDefaults];
  }
...
- (void)registerStoreDefaults {
  ...
  [NBMSettingsStore setDefaultsForVideoResolution:[self defaultVideoResolutionSetting]
