...
Pod::Spec.new do |spec|
  ...
  spec.name         = "WebRTCKurento.podspec"
  spec.version      = "1.0.0"
  spec.summary      = "A short description of WebRTCKurento.podspec."
  ...
  spec.description  = "Description for framewor "
  ...
  # Or just: spec.author    = "Zinzin"
  # spec.authors            = { "Zinzin" => "vudinhdin@gmail.com.vn" }
  # spec.social_media_url   = "https://twitter.com/Zinzin"
